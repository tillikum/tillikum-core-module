...
namespace Tillikum\Entity\Booking\Facility\Billing\Rate;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="tillikum_booking_facility_billing_rate", indexes={
...
{
    /**
     * @ORM\ManyToOne(targetEntity="Tillikum\Entity\Booking\Facility\Billing\Billing", inversedBy="rates")
