...
class DataTableBillingRuleFacilityBookingConfig extends AbstractHelper
{
    public function dataTableBillingRuleFacilityBookingConfig($configs)
    {
    ...
    {
        return $this->dataTableBillingRuleFacilityBookingConfig($configs);
    }
}
